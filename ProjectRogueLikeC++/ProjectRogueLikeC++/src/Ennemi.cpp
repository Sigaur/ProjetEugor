...
Ennemi::Ennemi(int id, std::string name, Position pos, int speed)
{
	this->m_id = id;
	this->m_name = name;
	this->m_pos = pos;
...
*/
Ennemi::Ennemi(int id, Position pos, monsterType type)
{
	switch (type)
	{
	case skeleton:
...
Ennemi::Ennemi(int id, Position pos, monsterType type, ennemiState state, Position objectif)
{
	switch (type)
	{
	case skeleton:
